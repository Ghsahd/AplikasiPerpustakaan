...
public class DataBukuFragment extends Fragment {
    ...
    private  ApiBuku apiBuku = new ApiBuku();

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_data_buku, container, false);

        SwipeRefreshLayout swipeRefreshLayout = view.findViewById(R.id.swipeRefreshLayoutDataBuku);
        ...
        exportButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog.show();
                createExcel("Data Buku", "Data Buku.xlsx", bukuList);
            }
        });
        return view;
    }
    ...
    private void addActionsToRow(TableRow row, final Context context, final String bookId) {
        ...
        editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.replace(R.id.fragmentContainerDataBuku, editDataBukuFragment);
...
//        row.addView(editButton);
    ...
    private void deleteBuku(String bookId) {
        apiBuku.deleteBuku(bookId, new ApiBuku.ApiResponseCallback<Void>() {
            @Override
