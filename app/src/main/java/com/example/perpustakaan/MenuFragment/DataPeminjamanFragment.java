...
public class DataPeminjamanFragment extends Fragment {
        private List<Peminjaman> peminjamanList = new ArrayList<>();
        private View view;
        private ProgressDialog progressDialog;
        private ApiPeminjaman apiPeminjaman = new ApiPeminjaman();

        @Override
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
           view = inflater.inflate(R.layout.fragment_data_peminjaman, container, false);
...
//        row.addView(editButton);
    ...
    private void deletePeminjaman(String bookId) {
        apiPeminjaman.deletePeminjaman(bookId, new ApiPeminjaman.ApiResponseCallback<Void>() {
            @Override
